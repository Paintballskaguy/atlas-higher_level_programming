...
for width and height, and methods to calculate area, perimeter, and
print the rectangle using the '#' character. It also includes a
__repr__ method to recreate a new instance.
"""
...
class Rectangle:
    ...
    and the ability to recreate a new instance with repr.
    """
