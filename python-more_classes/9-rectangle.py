...
track the number of instances, compare two rectangles based on their area,
...
class Rectangle:
    ...
    to compare two rectangles based on their area and a class method to create a square.
    """
